<?php
// source: C:\Users\Roman Hronza\OneDrive\Php\htdocs\AutentizaceAutorizace\app/config/config.neon 
// source: C:\Users\Roman Hronza\OneDrive\Php\htdocs\AutentizaceAutorizace\app/config/config.local.neon 

class Container_414589827a extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Forms\ChangePasswordFormFactory' => [1 => ['24_App_Forms_ChangePasswordFormFactory']],
			...
			'App\Model\PristupovaPrava' => [1 => ['28_App_Model_PristupovaPrava']],
			...
			'App\Presenters\AutorizacePresenter' => [1 => ['application.1']],
		...
		'services' => [
			'24_App_Forms_ChangePasswordFormFactory' => 'App\Forms\ChangePasswordFormFactory',
			...
			'28_App_Model_PristupovaPrava' => 'App\Model\PristupovaPrava',
			'29_App_Model_UserManager' => 'App\Model\UserManager',
			'application.1' => 'App\Presenters\AutorizacePresenter',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\Users\Roman Hronza\OneDrive\Php\htdocs\AutentizaceAutorizace\app',
			'wwwDir' => 'C:\Users\Roman Hronza\OneDrive\Php\htdocs\AutentizaceAutorizace\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\Users\Roman Hronza\OneDrive\Php\htdocs\AutentizaceAutorizace\app/../temp',
		];
	}


	public function createService__24_App_Forms_ChangePasswordFormFactory(): App\Forms\ChangePasswordFormFactory
	{
		$service = new App\Forms\ChangePasswordFormFactory($this->getService('25_App_Forms_FormFactory'),
			$this->getService('security.user'), $this->getService('29_App_Model_UserManager'));
		return $service;
	}
	...
	public function createService__27_App_Forms_SignUpFormFactory(): App\Forms\SignUpFormFactory
	{
		$service = new App\Forms\SignUpFormFactory($this->getService('25_App_Forms_FormFactory'),
			$this->getService('29_App_Model_UserManager'), $this->getService('security.user'));
		return $service;
	}


	public function createService__28_App_Model_PristupovaPrava(): App\Model\PristupovaPrava
	{
		$service = new App\Model\PristupovaPrava($this->getService('database.default.context'));
		return $service;
	}
	...
	public function createServiceApplication__1(): App\Presenters\AutorizacePresenter
	{
		$service = new App\Presenters\AutorizacePresenter($this->getService('database.default.context'),
			$this->getService('database.default.connection'), $this->getService('28_App_Model_PristupovaPrava'));
	...
	public function createServiceApplication__5(): App\Presenters\SignPresenter
	{
		$service = new App\Presenters\SignPresenter($this->getService('26_App_Forms_SignInFormFactory'),
			$this->getService('27_App_Forms_SignUpFormFactory'), $this->getService('24_App_Forms_ChangePasswordFormFactory'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\Users\Roman Hronza\OneDrive\Php\htdocs\AutentizaceAutorizace\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\Users\Roman Hronza\OneDrive\Php\htdocs\AutentizaceAutorizace\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\Users\Roman Hronza\OneDrive\Php\htdocs\AutentizaceAutorizace\app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=autentizaceautorizace',
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_414589827a $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\Users\Roman Hronza\OneDrive\Php\htdocs\AutentizaceAutorizace\app/../temp/cache/latte');
